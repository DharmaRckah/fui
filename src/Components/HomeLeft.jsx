...
//         <Link to="/technology">
//           <motion.button
//             className="px-4 py-7 hidden lg:block md:p-6 lg:p-6 absolute  w-[190%]  md:w-[110%] lg:w-[90%] left-0  lg:text-3xl md:text-2xl text-xl   uppercase origin-left text-white"
//             initial={{
